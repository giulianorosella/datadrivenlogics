...
Process 138296 was started by ale on arch.ariel.linux,
Tue May 14 11:44:25 2024
The command was "prover9/bin/LADR-2009-11A/bin/prover9 -f prover9/conf/default_input.in prover9/inputs_in/input_template_copy.in".
============================== end of head ===========================
...
% Reading from file prover9/inputs_in/input_template_copy.in
...
1 0 * 0 = 1 # label(non_clause) # label(goal).  [goal].
...
Function symbol precedence:  function_order([ 0, 1, ^, v, *, ' ]).
After inverse_order: Function symbol precedence:  function_order([ 0, 1, ^, v, ', * ]).
Unfolding symbols: */2.
...
Process 138296 exit (max_proofs) Tue May 14 11:44:25 2024
