...
from z3 import Bool, Implies, And, Or, Not, solve, CheckSatResult  # type: ignore # package required for checking in python whether a formula is a classical tautology or not
...
var_numbers = 1  # here the only thing we can change, ie- the number of variables we want to have
